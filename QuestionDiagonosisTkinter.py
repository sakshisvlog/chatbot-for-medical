...
training_dataset = pd.read_csv(r'C:\Users\lenovo\Desktop\BE Chatbot project\CODE\Health-Care-Chat-Bot\Training.csv')
test_dataset = pd.read_csv(r'C:\Users\lenovo\Desktop\BE Chatbot project\CODE\Health-Care-Chat-Bot\Testing.csv')
...
doc_dataset = pd.read_csv(r'C:\Users\lenovo\Desktop\BE Chatbot project\CODE\Health-Care-Chat-Bot\doctors_dataset.csv', names = ['Name', 'Description'])
...
#        master.minsize(700,350)
    ...
    def createWidget(self):
        ...
        self.btnTalk = Button(self, text="Talk",width=12,bg="bisque", command=self.btnTalk_Click)
        self.btnTalk.grid(row=24, column= 0)
    ...
    def btnTalk_Click(self):
        with sr.Microphone() as source:
            ...
            self.txtQuestion.insert(END,format(text)) 
...
class MainForm(Frame):
    ...
    def __init__(self, master=None):
        ...
        self.createWidget()
    def createWidget(self):
        self.lblMsg=Label(self,text="Health Care Chatbot", bg="PeachPuff2", width="500", height="4", font=("Calibri", 23))
        self.lblMsg.pack()
        self.btnLogin=Button(self, text="Login", height="2", width="400", command = self.lblLogin_Click, font = ('Calibri','14','bold'))
        self.btnLogin.pack()
        self.btnRegister=Button(self, text="Register", height="2", width="400", command = self.btnRegister_Click,  font = ('Calibri','14','bold'))
        self.btnRegister.pack()
        self.lblTeam=Label(self, text="Made by:", bg="#B2AC88", width = "200", height = "2", font=("Calibri", 22))
        self.lblTeam.pack()
        self.lblTeam1=Label(self, text="Sakshi Shetty", bg="RoyalBlue1", width = "300", height = "2", font=("Calibri", 13))
        self.lblTeam1.pack()
        self.lblTeam2=Label(self, text="Dheeraj Bhor", bg="RoyalBlue2", width = "300", height = "2", font=("Calibri", 13))
        self.lblTeam2.pack()
        self.lblTeam3=Label(self, text="Dhanashree Dhanajkar", bg="RoyalBlue1", width = "300", height = "2", font=("Calibri", 13))
        self.lblTeam3.pack()
        self.lblTeam4=Label(self, text="Abhishek Gaikwad", bg="RoyalBlue2", width = "300", height = "2", font=("Calibri", 13))
